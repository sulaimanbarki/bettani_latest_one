                    ...
                    <div class="u-sidebar__content u-header-sidebar__content">
                            ...
                            <div class="zeynep pt-4">
                                <ul>
                                    <li class="{{ Request::is('/')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('/')}}" data-submenu="off-pages">
                                            <i class="bi bi-house-check-fill mr-2"></i>
                                            Home
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('books')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('books')}}" data-submenu="off-pages">
                                            <i class="bi bi-book-fill mr-2"></i>
                                            Books
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('about-us')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('about-us')}}" data-submenu="off-pages">
                                            <i class="bi bi-info-circle-fill mr-2"></i>
                                            About Us
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('contact-us')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('contact-us')}}" data-submenu="off-pages">
                                            <i class="bi bi-telephone-fill mr-2"></i>
                                            Contact Us
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('test')  ? 'active border-bottom border-primary border-width-2' : '' }} ">
                                        <a href="{{url('test')}}" data-submenu="off-pages">
                                            <i class="bi bi-pencil-fill mr-2"></i>
                                            Test
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('intro-vidoes-mobile')  ? 'active border-bottom border-primary border-width-2' : '' }} menu-top-item">
                                        <a href="{{url('intro-vidoes-mobile')}}" data-submenu="off-pages" class="dropdown-toggle ">
                                            <i class="bi bi-film mr-2"></i>
                                            Videos
                                        </a>
                                        {{-- submenu --}}
                                        @php
                                            $menus = App\Models\DropDownMenu::where('parent_id', null)->where('is_active', 1)->get();
                                        @endphp
                                        @if ($menus->count() > 0)
                                        <ul class="dropdownmenu main-menu">
                                            ...
                                            @foreach ($menus as $item)
                                                ...
                                                @endphp
                                                    <li >
                                                        @if ($subMenu->count() > 0)
                                                            <a class="sub-menu-item dropdown-toggle">
                                                                {{ $item->title }}
                                                            </a>
                                                            <ul class="sub-dropdownmenu">
                                                                @foreach ($subMenu as $subItem)
                                                                <li>
                                                                    <a href="{{ url('/videos/'. $subItem->slug) }}">
                                                                        &nbsp;&nbsp;&nbsp; {{ $subItem->title }}
                                                                    </a>
                                                                </li>
                                                                @endforeach
                                                        ...
                                                        @else
                                                            <a href="/videos/{{ $item->slug }}">{{ $item->title }}</a>
                                                        @endif
                                                    </li>
                                            @endforeach
                                        </ul>
                                    ...
                                    <script>
                                        // menu top item click dropdown menu show using javascript
                                        var menuTopItem = document.querySelectorAll('.menu-top-item');
                                        menuTopItem.forEach(function (item) {
                                        ...
                                        // .sub-menu-item click sub-dropdownmenu show using javascript
                                        var subMenuItem = document.querySelectorAll('.sub-menu-item');
                                        subMenuItem.forEach(function (item) {
                                            item.addEventListener('click', function (e) {
                                                e.preventDefault();
                                                var subDropdownMenu = this.nextElementSibling;
                                                subDropdownMenu.classList.toggle('show');
                                            });
                                        });
                                        
                                        // on .main-menu click toggle show
                        ...
                        <div class="px-4 px-md-5 pt-5 pb-4 border-bottom">
                            ...
                            <ul class="list-group list-group-flush list-group-borderless">
                                ...
                                @if (Auth::guest())
                                <li class="list-group-item px-0 py-2 border-0"><a href="{{url('login')}}" class="h-primary">
