                                            ...
                                            <tbody>
                                                ...
                                                @php
                                                    ...
                                                    if($quiz->quiz_in_section != 0){
                                                        ...
                                                        $book = \App\Models\Book::where('id', $section->book_id)->first();
                                                        $description = $section->title;
                                                        // $description = $section->description;
                                                    }else{
                                                        $unit = DB::table('units')->where('id', $quiz->quiz_in_unit)->first();
                                                        $section = DB::table('sections')->where('id', $unit->section_id)->first();
                                                        $book = \App\Models\Book::where('id', $section->book_id)->first();
                                                        $description = $section->title;
                                                    }
                                                @endphp
                                ...
                                <div class="row align-items-center text-black  p-2 d-flex">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <form class="d-inline" action="wrong-questions" method="post" id="wrong_question_form">
                                            ...
                                            @else 
                                                Please buy book for online result
                                            @endif
                                        </form>
